...
class SimpleAI:
    """Simplified AI system that doesn't interfere with hybrid architecture"""
    def __init__(self):
        print("🧠 Simple AI System initialized")
    
    def get_basic_prediction(self, crop_type, storage_method):
        """Get basic prediction without complex parameters"""
        import random
        loss_percentage = random.uniform(5, 25) if 'dry' in storage_method.lower() else random.uniform(15, 35)
        return f"Predicted loss: {loss_percentage:.1f}%"
